...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '6520156713:AAERRzL_XZNU8s-5R_8pGRhk8JaioUK_6wo' # Get it from https://t.me/BotFather
    APP_ID = '18654447' # Get it from my.telegram.org/apps
    API_HASH = '60ac6f65c766e73dfcc1debef93d06bc' # Get it from my.telegram.org/apps
